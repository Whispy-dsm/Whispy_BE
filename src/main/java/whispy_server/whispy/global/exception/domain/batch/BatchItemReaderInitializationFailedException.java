...
public class BatchItemReaderInitializationFailedException extends WhispyException {
    ...
    /**
     * 원인 예외와 함께 ItemReader 초기화 실패 예외를 생성합니다.
     *
     * @param cause 원인 예외
     */
    public BatchItemReaderInitializationFailedException(Throwable cause) {
        super(ErrorCode.BATCH_ITEM_READER_INITIALIZATION_FAILED, cause);
    }
}
