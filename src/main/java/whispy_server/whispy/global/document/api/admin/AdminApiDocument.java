...
public interface AdminApiDocument {
    ...
    @Operation(summary = "모든 유저에게 새 토픽 추가", description = "모든 유저에게 새로운 토픽을 추가합니다.")
    @ApiResponses({
    ...
    @Operation(summary = "음악 생성", description = "새로운 음악을 생성합니다.")
    @ApiResponses({
    ...
    @Operation(summary = "음악 수정", description = "기존 음악 정보를 수정합니다.")
    @ApiResponses({
    ...
    @Operation(summary = "음악 삭제", description = "ID로 음악을 삭제합니다.")
    @ApiResponses({
    ...
    @Operation(summary = "공지사항 삭제", description = "ID로 공지사항을 삭제합니다.")
    @ApiResponses({
